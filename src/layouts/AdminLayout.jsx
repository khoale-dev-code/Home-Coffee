...
const navItems = [
  ...
  },
  {
    ...
    shortLabel: "Topping",
    description: "Tên topping và giá",
    icon: Sparkles,
  },
  {
...
function getPageTitle(pathname) {
  ...
  if (pathname.startsWith("/admin/toppings")) return "Danh sách topping";
...
function getPageDescription(pathname) {
  ...
  if (pathname.startsWith("/admin/toppings")) {
    return "Quản lý topping chung của quán để khách xem tên và giá.";
  }
...
export default function AdminLayout() {
  ...
  if (authLoading) {
    return (
      <main className="grid min-h-[100dvh] place-items-center bg-[#f6f7e8] px-4">
        <div className="w-full max-w-sm rounded-[14px] border border-[#d9dda9] bg-white p-8 text-center shadow-sm">
          <div className="mx-auto h-10 w-10 animate-spin rounded-full border-4 border-[#d9dda9] border-t-[#294f31]" />
  ...
  return (
    <div className="min-h-[100dvh] bg-[#f6f7e8] text-[#294f31]">
      <DesktopSidebar
        user={user}
        shop={shop}
      ...
      >
        <header className="sticky top-0 z-30 border-b border-[#d9dda9] bg-white/95 backdrop-blur-xl">
          <div className="flex h-16 items-center justify-between gap-3 px-3 sm:px-6 lg:h-20 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              <button
                type="button"
                onClick={() => setMobileOpen(true)}
                className="grid h-10 w-10 shrink-0 place-items-center rounded-[8px] border border-[#d9dda9] bg-white text-[#294f31] shadow-sm lg:hidden"
              ...
              <button
                ...
                className="hidden h-10 w-10 shrink-0 place-items-center rounded-[10px] border border-[#d9dda9] bg-white text-[#294f31] shadow-sm transition hover:bg-[#f7f8ec] lg:grid"
                aria-label={
              ...
              <div className="min-w-0">
                <p className="truncate text-lg font-black tracking-tight text-[#294f31] sm:text-xl lg:text-2xl">
                  {pageTitle}
                </p>
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <button
                ...
                className="hidden items-center gap-2 rounded-[8px] bg-[#294f31] px-4 py-2.5 text-sm font-black !text-white transition hover:bg-[#1f3d26] sm:inline-flex"
              >
...
function DesktopSidebar({
  ...
  return (
    <aside
      className={[
        "fixed left-0 top-0 hidden h-[100dvh] border-r border-[#d9dda9] bg-white transition-[width] duration-300 ease-out lg:flex lg:flex-col",
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={[
            "mt-3 hidden items-center justify-center gap-2 rounded-[12px] border border-[#d9dda9] bg-white text-sm font-black text-[#294f31] shadow-sm transition hover:bg-[#f7f8ec] lg:flex",
        ...
        <div
          className={[
            "mt-4 space-y-3 border-t border-[#d9dda9] pt-4",
            collapsed && "space-y-2",
          ]
            .filter(Boolean)
            .join(" ")}
        >
          ...
          <button
            ...
            onClick={onLogout}
            className={[
              "flex w-full items-center justify-center gap-2 rounded-[12px] bg-[#294f31] text-sm font-black !text-white transition hover:bg-[#1f3d26]",
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <aside className="relative flex h-[100dvh] w-[92%] max-w-[360px] flex-col overflow-y-auto bg-white p-3 shadow-2xl sm:p-4">
        <div className="flex items-center justify-between gap-3 border-b border-[#d9dda9] pb-3">
          <p className="text-lg font-black text-[#294f31]">Admin Panel</p>

          <button
            type="button"
            onClick={onClose}
            className="grid h-10 w-10 place-items-center rounded-[8px] bg-neutral-100 text-[#294f31]"
        ...
        <div className="mt-auto space-y-3 border-t border-[#d9dda9] pt-4">
          <PublicMenuButton publicPath={publicPath} shopLoading={shopLoading} />

          <button
            type="button"
            onClick={onLogout}
            className="flex w-full items-center justify-center gap-2 rounded-[10px] bg-[#294f31] px-4 py-3 text-sm font-black !text-white"
          >
            <LogOut size={17} className="text-white" />
...
function HeaderPublicButton({ publicPath, shopLoading }) {
  if (shopLoading) {
    return (
      <button
        type="button"
        disabled
        className="grid h-10 w-10 place-items-center rounded-[8px] border border-[#d9dda9] bg-white text-neutral-400 shadow-sm sm:inline-flex sm:w-auto sm:gap-2 sm:px-4"
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      className="grid h-10 w-10 place-items-center rounded-[8px] border border-[#d9dda9] bg-white text-[#294f31] shadow-sm transition hover:bg-[#f7f8ec] sm:inline-flex sm:w-auto sm:gap-2 sm:px-4"
...
function PublicMenuButton({ publicPath, shopLoading, collapsed = false }) {
  if (shopLoading) {
    return (
      <button
        ...
        disabled
        className={[
          "flex w-full items-center justify-center gap-2 rounded-[12px] border border-[#d9dda9] bg-white text-sm font-black text-neutral-400",
          collapsed ? "h-12 px-0" : "px-4 py-3",
        ].join(" ")}
        title="Đang tải link"
      >
  ...
  return (
    <Link
      ...
      rel="noreferrer"
      className={[
        "flex w-full items-center justify-center gap-2 rounded-[12px] border border-[#d9dda9] bg-white text-sm font-black text-[#294f31] transition hover:bg-[#f7f8ec]",
        collapsed ? "h-12 px-0" : "px-4 py-3",
      ].join(" ")}
...
function MobileBottomNav() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-[#d9dda9] bg-white/95 px-1.5 pb-[max(8px,env(safe-area-inset-bottom))] pt-2 shadow-[0_-10px_30px_rgba(0,0,0,0.08)] backdrop-blur-xl lg:hidden">
      <div
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ? "bg-neutral-100 text-[#294f31]"
                    : "bg-transparent text-neutral-500 hover:bg-[#f7f8ec] hover:text-[#294f31]",
                ].join(" ")
              }
            >
              {({ isActive }) => (
                <>
                  <span
                    className={[
                      ...
                      isActive
                        ...
                        : "bg-transparent text-neutral-500 group-hover:bg-white group-hover:text-[#294f31]",
                    ].join(" ")}
                  >
                    <Icon size={17} />
                  </span>
                  ...
                  <span
                    className={[
                      ...
                      isActive ? "text-[#294f31]" : "text-neutral-500",
                    ].join(" ")}
                  >
                    {item.shortLabel}
                  </span>
...
function BrandBox({ user, shop, compact = false, collapsed = false }) {
  if (collapsed) {
    return (
      <div className="grid place-items-center rounded-[16px] bg-[#294f31] p-2.5 text-white shadow-sm">
  ...
  return (
    <div className="rounded-[18px] bg-[#294f31] p-4 text-white shadow-sm">
      <div className="flex min-w-0 items-center gap-3">
        <ShopLogo shop={shop} />
...
function ShopLogo({ shop, small = false }) {
  ...
  return (
    <div
      className={[
        "grid shrink-0 place-items-center overflow-hidden rounded-[14px] bg-[#294f31] text-[#294f31] ring-1 ring-[#d9dda9]",
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        [
          ...
          isActive
            ? "bg-[#294f31] text-white shadow-sm"
            : "bg-white text-neutral-700 hover:bg-neutral-100 hover:text-[#294f31]",
        ].join(" ")
      }
    >
      {({ isActive }) => (
          ...
          <div
            className={[
              ...
              isActive
                ...
                : "bg-neutral-100 text-neutral-500 group-hover:bg-white group-hover:text-[#294f31]",
            ].join(" ")}
          >
