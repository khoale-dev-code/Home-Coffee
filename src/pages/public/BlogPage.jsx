  ...
  return (
    <div style={{
      ...
      <Link
        ...
        onMouseEnter={e => e.currentTarget.style.color = "#294f31"}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 14 }}>
            ...
            <Link
              ...
              style={{
                ...
                fontSize: 12, fontWeight: 600, color: "#294f31",
                textDecoration: "none",
                background: "#F5EBE0",
...
export default function BlogPage() {
  ...
  return (
    <main style={{ minHeight: "100svh", background: "#fff", color: "#294f31" }}>
