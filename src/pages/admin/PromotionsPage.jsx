    ...
    for (const draft of mediaDrafts) {
      if (draft.source === "file") {
        const uploaded = await uploadMediaFilesToCloudinary(
          [draft.file],
          `home-coffee/${DEFAULT_SHOP_ID}/promotions`
        );
...
function PageTopHeader({ loading, onRefresh, count }) {
  return (
    <div className="rounded-[12px] border border-[#d9dda9] bg-white p-3 shadow-sm sm:p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-black text-[#294f31] sm:text-3xl">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <button
            ...
            onClick={onRefresh}
            disabled={loading}
            className="inline-flex items-center justify-center gap-2 rounded-[8px] border border-[#d9dda9] bg-white px-4 py-3 text-sm font-black text-[#294f31] transition hover:bg-[#f7f8ec] disabled:opacity-60"
          >
...
function MobileTabBar({ activeTab, setActiveTab }) {
  return (
    <div className="sticky top-0 z-30 -mx-3 border-y border-[#d9dda9] bg-white/95 px-3 py-2 backdrop-blur-xl sm:-mx-5 sm:px-5 lg:hidden">
      <div className="grid grid-cols-2 gap-2 rounded-[12px] border border-[#d9dda9] bg-[#f7f8ec] p-1">
        {mobileTabs.map((tab) => {
          const Icon = tab.icon;
            ...
            <button
              ...
              className={[
                ...
                active
                  ...
                  : "bg-transparent text-neutral-500 hover:bg-white hover:text-[#294f31]",
              ].join(" ")}
            >
              <Icon size={15} />
...
function PromotionFormPanel({
  ...
  return (
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-3 shadow-sm sm:p-5">
      <div className="flex items-start justify-between gap-3 border-b border-[#d9dda9] pb-4">
        <div>
          <h2 className="text-xl font-black text-[#294f31]">
      ...
      <form onSubmit={onSubmit} className="mt-4 space-y-4">
        ...
        <FormSection title="Media khuyến mãi">
          <label className="flex min-h-[150px] cursor-pointer flex-col items-center justify-center rounded-[10px] border border-dashed border-neutral-300 bg-[#f7f8ec] p-4 text-center transition hover:bg-neutral-100">
            ...
            <span className="mt-3 inline-flex rounded-[8px] bg-[#294f31] px-4 py-2.5 text-xs font-black uppercase tracking-[0.08em] text-white">
              Chọn file
            </span>
        ...
        <div className="sticky bottom-3 z-10 rounded-[12px] bg-white/95 pt-2 backdrop-blur sm:static sm:bg-transparent sm:pt-0">
          <button
            type="submit"
            disabled={submitting}
            className="inline-flex w-full items-center justify-center gap-2 rounded-[8px] bg-[#294f31] px-4 py-4 text-sm font-black uppercase tracking-[0.08em] text-white shadow-[0_12px_26px_rgba(0,0,0,0.16)] transition hover:bg-[#1f3d26] disabled:opacity-60 sm:py-3 sm:shadow-none"
          >
            {submitting ? (
...
function UrlMediaBox({ urlForm, updateUrlField, onAddUrlMedia }) {
  return (
    <div className="rounded-[10px] border border-[#d9dda9] bg-[#f7f8ec] p-3 sm:p-4">
      <div className="flex items-center gap-2">
        <Link2 size={18} className="text-neutral-500" />
        <p className="text-sm font-black text-[#294f31]">Thêm bằng link URL</p>
      </div>
      ...
      <div className="mt-3 space-y-3">
        <input
          ...
          className="h-12 w-full rounded-[8px] border border-[#d9dda9] bg-white px-4 text-sm font-bold text-[#294f31] outline-none transition placeholder:text-neutral-400 focus:border-[#294f31]"
        />
        ...
        <div className="grid gap-3 min-[430px]:grid-cols-[1fr_130px]">
          ...
          <select
            ...
            className="h-12 w-full rounded-[8px] border border-[#d9dda9] bg-white px-4 text-sm font-black text-[#294f31] outline-none transition focus:border-[#294f31]"
          >
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-[8px] bg-[#294f31] px-4 py-3 text-sm font-black text-white transition hover:bg-[#1f3d26]"
        >
          <Link2 size={17} />
...
function PromotionsListPanel({
  ...
  return (
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-3 shadow-sm sm:p-5">
      <div className="flex flex-col gap-3 border-b border-[#d9dda9] pb-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-xl font-black text-[#294f31]">
      ...
      {loading ? (
        ...
        <div className="mt-4 space-y-3 sm:mt-5">
          {promotions.length === 0 && (
            <div className="rounded-[10px] border border-dashed border-[#d9dda9] bg-[#f7f8ec] p-8 text-center">
...
function PromotionCard({ promotion, onEdit, onDelete, onToggleActive }) {
  ...
  return (
    <article className="overflow-hidden rounded-[12px] border border-[#d9dda9] bg-white shadow-sm transition hover:border-neutral-300 hover:shadow-md">
      <div className="grid gap-0 md:grid-cols-[220px_1fr] xl:grid-cols-[240px_1fr]">
        <div className="border-b border-neutral-100 bg-[#f7f8ec] md:border-b-0 md:border-r">
        ...
        <div className="p-3 sm:p-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <h3 className="line-clamp-2 text-base font-black leading-6 text-[#294f31] sm:text-lg">
                {promotion.title}
              </h3>
          ...
          <button
            ...
            className="mt-4 inline-flex w-full items-center justify-center rounded-[8px] border border-[#d9dda9] bg-white px-4 py-3 text-sm font-black text-[#294f31] transition hover:bg-[#f7f8ec] sm:w-auto sm:py-2"
          >
  ...
  return (
    <div
      ...
      className={[
        ...
        isDragging
          ? "z-50 border-[#294f31] shadow-xl"
          : "border-[#d9dda9]",
      ].join(" ")}
    >
      <div className="relative grid min-h-32 place-items-center bg-[#f7f8ec]">
        {media.type === "video" ? (
          <video
            src={media.url}
...
function AdminMediaThumb({ media }) {
  ...
  if (media.type === "video") {
    return (
      <div className="relative grid h-44 place-items-center bg-[#f7f8ec] sm:h-48">
        <video
          src={media.url}
  ...
  return (
    <div className="grid h-44 place-items-center bg-[#f7f8ec] sm:h-48">
      <img
        src={media.url}
...
function FormSection({ title, children }) {
  return (
    <div className="rounded-[12px] border border-[#d9dda9] bg-white p-3 sm:p-4">
      <p className="mb-4 text-sm font-black text-[#294f31]">{title}</p>
...
function ToggleCard({ label, description, checked, onChange }) {
  return (
    <label className="flex cursor-pointer items-start gap-3 rounded-[10px] border border-[#d9dda9] bg-white p-3 transition hover:border-neutral-300">
      <input
        type="checkbox"
        checked={checked}
  ...
  return (
    <div className="mt-5 space-y-3">
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={index}
          className="rounded-[12px] border border-[#d9dda9] bg-white p-3 shadow-sm"
        >
  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="mt-2 w-full resize-none rounded-[8px] border border-[#d9dda9] bg-white px-4 py-3 text-sm font-bold text-[#294f31] outline-none transition placeholder:text-neutral-400 focus:border-[#294f31]"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <input
        ...
        placeholder={placeholder}
        required={required}
        className="mt-2 h-12 w-full rounded-[8px] border border-[#d9dda9] bg-white px-4 text-sm font-bold text-[#294f31] outline-none transition placeholder:text-neutral-400 focus:border-[#294f31]"
      />
    </div>
  );
}
