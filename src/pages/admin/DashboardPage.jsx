...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <section className="rounded-[12px] border border-[#d9dda9] bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-1 text-2xl font-black tracking-tight text-[#294f31] sm:text-3xl">
              Tổng quan menu
            </h1>
          ...
          <div className="grid gap-2 min-[430px]:grid-cols-3 xl:flex xl:shrink-0">
            <button
              ...
              disabled={refreshing}
              className="inline-flex h-11 items-center justify-center gap-2 rounded-[8px] border border-[#d9dda9] bg-white px-4 text-sm font-black text-neutral-700 transition hover:bg-[#f7f8ec] disabled:opacity-60"
            >
              {refreshing ? (
            ...
            {publicPath && (
              <Link
                to={publicPath}
                target="_blank"
                className="inline-flex h-11 items-center justify-center gap-2 rounded-[8px] bg-[#294f31] px-4 text-sm font-black !text-white transition hover:bg-[#1f3d26] hover:!text-white"
              >
            ...
            <Link
              to="/admin/settings"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-[8px] border border-[#d9dda9] bg-white px-4 text-sm font-black text-neutral-700 transition hover:bg-[#f7f8ec]"
            >
              <Settings size={17} />
              Cài đặt
            </Link>
...
function StatCard({ icon: Icon, label, value, highlight, description }) {
  return (
    <div className="rounded-[12px] border border-[#d9dda9] bg-white p-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md sm:p-5">
      <div className="flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="mt-2 text-3xl font-black tracking-tight text-[#294f31] sm:text-4xl">
            {value}
          </p>
        </div>

        <div className="grid h-10 w-10 shrink-0 place-items-center rounded-[10px] bg-[#294f31] text-white sm:h-12 sm:w-12">
          <Icon size={20} />
        </div>
      </div>
    ...
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-4 shadow-sm sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-xl font-black text-[#294f31]">
      ...
      <div className="mt-4 rounded-[12px] border border-[#d9dda9] bg-[#f7f8ec] p-3 sm:p-4">
        ...
        <div className="mt-2 grid gap-2 lg:grid-cols-[1fr_auto] lg:items-center">
          <p className="min-w-0 break-all rounded-[8px] bg-white px-3 py-3 text-sm font-bold text-neutral-700 ring-1 ring-[#d9dda9]">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-[8px] bg-[#294f31] px-4 text-sm font-black text-white transition hover:bg-[#1f3d26] disabled:opacity-50"
            >
              <Copy size={16} />
              Copy
            </button>
    ...
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-4 shadow-sm sm:p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="shrink-0 text-right">
          <p className="text-3xl font-black text-[#294f31]">{percent}%</p>
      ...
      <div className="mt-5 h-3 overflow-hidden rounded-full bg-neutral-100">
        <div
          className="h-full rounded-full bg-[#294f31] transition-all"
          style={{ width: `${percent}%` }}
        />
      </div>
      ...
      <div className="mt-5 space-y-3">
        {checks.map((check) => (
          <div
            key={check.label}
            className="flex items-start gap-3 rounded-[10px] border border-neutral-100 bg-[#f7f8ec] p-3"
          >
            <div
            ...
            <div className="min-w-0">
              <p className="font-black text-[#294f31]">{check.label}</p>
    ...
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-4 shadow-sm sm:p-5">
      <div className="flex flex-col gap-3 min-[430px]:flex-row min-[430px]:items-start min-[430px]:justify-between">
        ...
        <Link
          to={publicPath}
          target="_blank"
          className="inline-flex h-10 items-center justify-center gap-2 rounded-[8px] bg-[#294f31] px-3 text-xs font-black !text-white transition hover:bg-[#1f3d26] hover:!text-white"
        >
          <span className="text-white">Xem menu</span>
        ...
        {actions.map((action) => {
          ...
          return (
            <Link
              key={action.to}
              to={action.to}
              className="group flex items-center gap-3 rounded-[10px] border border-neutral-100 bg-[#f7f8ec] p-3 transition hover:border-[#d9dda9] hover:bg-white hover:shadow-sm sm:gap-4 sm:p-4"
            >
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-[9px] bg-white text-neutral-700 ring-1 ring-[#d9dda9] group-hover:bg-[#294f31] group-hover:text-white sm:h-11 sm:w-11">
                <Icon size={19} />
              </div>
              ...
              <ArrowRight
                size={18}
                className="shrink-0 text-neutral-400 transition group-hover:translate-x-1 group-hover:text-[#294f31]"
              />
            </Link>
          );
        })}
...
function RecentItemsCard({ items }) {
  return (
    <section className="rounded-[12px] border border-[#d9dda9] bg-white p-4 shadow-sm sm:p-5">
      ...
      <div className="mt-5 space-y-3">
        {items.length === 0 && (
          <div className="rounded-[10px] border border-dashed border-[#d9dda9] bg-[#f7f8ec] p-6 text-center">
        ...
        {items.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="grid grid-cols-[64px_1fr] gap-3 rounded-[10px] border border-neutral-100 bg-[#f7f8ec] p-3"
            >
              ...
              <div className="min-w-0">
                <p className="line-clamp-1 font-black text-[#294f31]">
                  {item.name}
                </p>
...
function InfoRow({ label, value, icon: Icon }) {
  return (
    <div className="rounded-[10px] border border-neutral-100 bg-[#f7f8ec] p-3 sm:p-4">
      <div className="flex items-center gap-2">
      ...
      <p className="mt-1 break-words font-black text-[#294f31]">{value}</p>
    </div>
  );
}
