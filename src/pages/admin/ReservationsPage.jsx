...
const DEFAULT_SHOP_ID = import.meta.env.VITE_DEFAULT_SHOP_ID || "home-coffee";
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-4">
      <section className="overflow-hidden rounded-[18px] border border-[#d9dda9] bg-white shadow-sm">
        <div className="relative overflow-hidden bg-[#294f31] p-4 text-white sm:p-5 lg:p-6">
          <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-[#294f31]/20 blur-2xl" />
          <div className="absolute -bottom-16 left-10 h-44 w-44 rounded-full bg-[#294f31]/15 blur-3xl" />
          ...
          <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <button
              ...
              disabled={loading}
              className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-[12px] bg-white px-4 text-sm font-black text-[#294f31] shadow-sm transition hover:bg-neutral-100 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
            >
              {loading ? (
                <Loader2 size={16} className="animate-spin text-[#294f31]" />
              ) : (
                <RefreshCcw size={16} className="text-[#294f31]" />
              )}
      ...
      <section className="overflow-hidden rounded-[18px] border border-[#d9dda9] bg-white shadow-sm">
        <div className="border-b border-[#d9dda9] bg-white p-3 sm:p-4">
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            <div className="relative min-w-0">
              ...
              <input
                ...
                className="h-11 w-full rounded-[12px] border border-[#d9dda9] bg-[#f7f8ec] pl-10 pr-3 text-sm font-bold text-[#294f31] outline-none transition placeholder:text-neutral-400 focus:border-[#294f31] focus:bg-white"
              />
            </div>
                  ...
                  <button
                    ...
                    className={[
                      ...
                      active
                        ...
                        : "border-[#d9dda9] bg-white text-neutral-600 hover:bg-[#f7f8ec]",
                    ].join(" ")}
                  >
...
function StatCard({ label, value, icon: Icon, tone = "neutral" }) {
  ...
  return (
    <div className="rounded-[16px] border border-[#d9dda9] bg-white p-3 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md sm:p-4">
...
function ReservationCard({
  ...
  return (
    ...
    >
      <div className="grid gap-3 bg-white/80 p-3 sm:p-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-start">
        <div className="min-w-0">
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            ...
            <h2 className="break-words text-base font-black leading-6 text-[#294f31] sm:text-lg">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:shrink-0">
          <a
            ...
            className="inline-flex h-10 min-w-0 items-center justify-center gap-2 rounded-[12px] bg-[#294f31] px-3 text-sm font-black !text-white transition hover:bg-[#1f3d26]"
          >
        ...
        <div className="bg-white px-3 py-3 sm:px-4">
          <div className="rounded-[14px] border border-[#d9dda9] bg-[#f7f8ec] p-3">
            <div className="flex items-start gap-2">
              <div className="grid h-8 w-8 shrink-0 place-items-center rounded-[10px] bg-white text-neutral-600 ring-1 ring-[#d9dda9]">
      ...
      <div className="grid gap-2 bg-[#f7f8ec] p-3 sm:p-4 md:grid-cols-3">
        <button
          type="button"
...
function InfoBox({ icon: Icon, label, value }) {
  return (
    <div className="min-w-0 rounded-[14px] border border-[#d9dda9] bg-[#f7f8ec] p-3">
      <div className="flex min-w-0 items-start gap-2">
        <div className="grid h-9 w-9 shrink-0 place-items-center rounded-[11px] bg-white text-[#294f31] ring-1 ring-[#d9dda9]">
          <Icon size={16} className="text-[#294f31]" />
        </div>
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 break-words text-sm font-black leading-5 text-[#294f31]">
            {value}
          </p>
        </div>
      </div>
  ...
  return (
    <div className="grid gap-3">
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={index}
          className="h-48 animate-pulse rounded-[16px] border border-[#d9dda9] bg-[#f7f8ec]"
        />
      ))}
    </div>
  );
...
function EmptyState() {
  return (
    <div className="rounded-[16px] border border-dashed border-[#d9dda9] bg-[#f7f8ec] px-5 py-12 text-center">
      <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-white text-neutral-400 ring-1 ring-[#d9dda9]">
        <UserRound size={30} />
      </div>

      <p className="mt-3 text-base font-black text-[#294f31]">
