...
<img src="public/logohome.png" alt="Home Coffee Logo" width="120" />
...
<p>
  <strong>🔗 Demo trực tiếp:</strong> <a href="https://www.home-coffee-menue.website/hop-caffe">home-coffee-menue.website/hop-caffe</a> — quán <strong>Home Coffee</strong>
</p>
...
Dự án đang chạy thực tế cho quán **Home Coffee** tại domain riêng `home-coffee-menue.website`, với mỗi quán được định danh bằng một `shopSlug` riêng trên cùng hệ thống:
...
**🧑‍🤝‍🧑 Trang khách**
```
https://www.home-coffee-menue.website/hop-caffe
https://www.home-coffee-menue.website/hop-caffe/blog
```
...
**🔐 Trang quản trị**
```
https://www.home-coffee-menue.website/admin/login
https://www.home-coffee-menue.website/admin/dashboard
```
...
<div align="center">
  <sub>Đang phục vụ thực tế cho quán <a href="https://www.home-coffee-menue.website/hop-caffe">Home Coffee</a> ☕</sub>
  <br />
